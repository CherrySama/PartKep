...
if __name__ == "__main__":
    ...
    # 架构守卫：w_flip 已从语义层移除，翻转保护由 C2=(1-dot)² 在几何层内建
    ...
    raw_valid = json.dumps({
        "w_grasp_axis": 1.5, "w_safety": 2.5,
        "confidence": 0.9, "reasoning": "handle detected"
    })
